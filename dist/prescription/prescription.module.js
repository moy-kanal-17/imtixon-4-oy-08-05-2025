...
exports.PrescriptionsModule = PrescriptionsModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([prescription_entity_1.Prescription])],
        providers: [prescription_service_1.PrescriptionsService],
        controllers: [prescription_controller_1.PrescriptionsController],
    })
], PrescriptionsModule);
